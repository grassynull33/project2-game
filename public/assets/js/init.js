...
(function ($) {
  skel.init({
    ...
    breakpoints: {
      ...
      'narrower': { range: '-960', href: '/assets/css/style-narrower.css', containers: '100%', grid: { gutters: 20 } },
      'mobile': { range: '-736', href: '/assets/css/style-mobile.css', containers: '100%!', grid: { collapse: true } }
    },
    plugins: {
      layers: {
        sidePanel: {
